...
<head>
    ...
    <meta name="description" content="About SpaceX and its missions.">
    <meta name="keywords" content="SpaceX, about, missions, Elon Musk, Falcon 9, Starship">
...
<body>
    ...
    <section class="about-content">
        <div class="container-info">
            ...
            <h2>Foundational Vision and Goals</h2>
            <p>SpaceX was founded by Elon Musk with the overarching goal to reduce space transportation costs to enable the colonization of Mars. This vision stems from Musk's belief in making life multiplanetary to ensure human survival beyond Earth.</p>

            <h2>Key Achievements</h2>
            <div class="achievement-list">
                <h3>Firsts in Space Travel:</h3>
                <ul>
                    <li>First private company to send a liquid-fueled rocket into orbit (Falcon 1)</li>
                    <li>First to successfully launch, orbit, and recover a spacecraft (Dragon)</li>
                    <li>First to send astronauts to the ISS with a private spacecraft</li>
                </ul>
            </div>
            ...
            <div class="specs-grid">
                <div class="spec-item">
                    <h3>Falcon 1</h3>
                    <p>SpaceX's initial rocket, demonstrating orbital technology</p>
                </div>
                <div class="spec-item">
                    <h3>Falcon 9</h3>
                    <p>Nine-engine rocket for satellite delivery and crewed missions</p>
                </div>
                <div class="spec-item">
                    <h3>Falcon Heavy</h3>
                    <p>Most powerful operational rocket as of 2020</p>
                </div>
                <div class="spec-item">
                    <h3>Starship</h3>
                    <p>Next-generation vehicle for interplanetary travel</p>
                </div>
            </div>

            <h2>Technological Innovations</h2>
            <ul class="tech-list">
                <li><strong>Raptor Engine:</strong> Methane-fueled engine for Starship</li>
                <li><strong>In-Orbit Refueling:</strong> Technology for Mars missions</li>
                <li><strong>Heat Shield Technology:</strong> Advanced designs for re-entry</li>
            </ul>
            ...
            <div class="timeline">
                <div class="timeline-item">
                    ...
                    <p>Establish self-sustaining colony using Starship</p>
                </div>
                <div class="timeline-item">
                    <h3>Lunar Missions</h3>
                    <p>Part of NASA's Artemis program</p>
                </div>
                <div class="timeline-item">
                    <h3>Starlink</h3>
                    <p>Global broadband internet coverage</p>
                </div>
            </div>
